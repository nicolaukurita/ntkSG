...
delete from campo;
INSERT INTO campo (id, DICIONARIO_ID, nome, display_name, tipo, entidade_id, FIELD_ORDER, INPUT_OUTPUT_TYPE) VALUES (1, 1, 'productId', 'Product Id', 'number', 1, 10, 'O');
INSERT INTO campo (id, DICIONARIO_ID, nome, display_name, tipo, entidade_id, FIELD_ORDER, INPUT_OUTPUT_TYPE, HAS_FILTER, LINK_FIELD) VALUES (2,2, 'productName', 'Product', 'text', 1, 30, 'IO', TRUE, 'productId');
INSERT INTO campo (id, DICIONARIO_ID, nome, display_name, tipo, entidade_id, FIELD_ORDER, INPUT_OUTPUT_TYPE, OUTPUT_FORMAT) VALUES (3,3, 'productCode', 'Code', 'text', 1, 40, 'IO','| lowercase');
INSERT INTO campo (id, DICIONARIO_ID, nome, display_name, tipo, entidade_id, FIELD_ORDER, INPUT_OUTPUT_TYPE) VALUES (4,4, 'releaseDate', 'Available', 'text', 1, 50, 'IO');
INSERT INTO campo (id, DICIONARIO_ID, nome, display_name, tipo, entidade_id, FIELD_ORDER, INPUT_OUTPUT_TYPE, OUTPUT_FORMAT) VALUES (5,5, 'price', 'Price', 'number', 1, 60, 'IO','| currency:"USD":"symbol":"1.2-2"');
INSERT INTO campo (id, DICIONARIO_ID, nome, display_name, tipo, entidade_id, FIELD_ORDER, INPUT_OUTPUT_TYPE) VALUES (6,6, 'description', 'Description', 'text', 1, 70, 'O');
INSERT INTO campo (id, DICIONARIO_ID, nome, display_name, tipo, entidade_id, FIELD_ORDER, INPUT_OUTPUT_TYPE) VALUES (7,7, 'starRating', '5 Star Rating', 'number', 1, 80, 'IO');
INSERT INTO campo (id, DICIONARIO_ID, nome, display_name, tipo, entidade_id, FIELD_ORDER, INPUT_OUTPUT_TYPE, IMAGE_MARGIN, IMAGE_WIDTH, IMAGE_TITLE) VALUES (8,8, 'imageUrl', 'Show Image', 'imageUrl', 1, 20, 'IO', 2, 20, 'productName');

DELETE FROM DICIONARIO;
insert into DICIONARIO (ID ,NAME ,DISPLAY_NAME ,TYPE ) VALUES (1, 'productId', 'Product Id', 'number');
insert into DICIONARIO (ID ,NAME ,DISPLAY_NAME ,TYPE ) VALUES (2, 'productName', 'Product', 'text');
insert into DICIONARIO (ID ,NAME ,DISPLAY_NAME ,TYPE ) VALUES (3, 'productCode', 'Code', 'text');
insert into DICIONARIO (ID ,NAME ,DISPLAY_NAME ,TYPE ) VALUES (4, 'releaseDate', 'Available', 'text');
insert into DICIONARIO (ID ,NAME ,DISPLAY_NAME ,TYPE ) VALUES (5, 'price', 'Price', 'number');
insert into DICIONARIO (ID ,NAME ,DISPLAY_NAME ,TYPE ) VALUES (6, 'description', 'Description', 'text');
insert into DICIONARIO (ID ,NAME ,DISPLAY_NAME ,TYPE ) VALUES (7, 'starRating', '5 Star Rating', 'number');
insert into DICIONARIO (ID ,NAME ,DISPLAY_NAME ,TYPE ) VALUES (8, 'imageUrl', 'Show Image', 'imageUrl');
